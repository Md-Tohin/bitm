<?php include "resources/views/frontend/includes/header.php" ?>
...
<div class="body-content">
    <div class="container">
        <div class="sign-in-page">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 sign-in">
                    ...
                    <form action="<?php route('page=home') ?>" method="get" class="register-form outer-top-xs" role="form">
        ...
        <!-- ============================================== BRANDS CAROUSEL ============================================== -->
        <?php include "resources/views/frontend/includes/brand.php" ?>
        <!-- ============================================== BRANDS CAROUSEL : END ============================================== -->
    </div><!-- /.container -->
</div><!-- /.body-content -->


<?php include "resources/views/frontend/includes/footer.php" ?>