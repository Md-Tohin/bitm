							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="cart-image">
											<a class="entry-thumbnail" href="detail.html">
												<img src="<?php asset('frontend') ?>assets//images/products/p1.jpg" alt="">
											</a>
										</td>
										...
										<td class="cart-product-sub-total"><span
												class="cart-sub-total-price">$300.00</span></td>
									...
									<tr>
										...
										<td class="cart-image">
											<a class="entry-thumbnail" href="detail.html">
												<img src="<?php asset('frontend') ?>assets//images/products/p2.jpg" alt="">
											</a>
										</td>
										<td class="cart-product-name-info">
											<h4 class='cart-product-description'><a href="detail.html">Floral Print
